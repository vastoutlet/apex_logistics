import 'package:apex_logistics/views/onboarding/onboardingModel.dart';
...
class OnboardingItems {
  List<OnboardingInfo> items = [
    ...
    OnboardingInfo(
      ...
      title: "Fast Delivery",
      desc:
          "Experience speedy deliveries with our efficient logistics system. We ensure your packages reach their destination quickly and reliably.",
    ),
  ];
}
